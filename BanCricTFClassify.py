...
varPath = '/home/sezan92/BangladeshiCricketers/Test'
destDir = "//home/sezan92/BangladeshiCricketers/TestTF"
imgFiles = [f for f in listdir(varPath) if isfile(join(varPath, f))]


# Loads label file, strips off carriage return
label_lines = [line.rstrip() for line 
                   in tf.gfile.GFile("/home/sezan92/BangladeshiCricketers/output_labels.txt")]

# Unpersists graph from file
with tf.gfile.FastGFile("/home/sezan92/BangladeshiCricketers/output_graph.pb", 'rb') as f:
...
with tf.Session() as sess:
    ...
    for imageFile in imgFiles:
        ...
        for node_id in top_k:
            ...
            plt.title('%s (score = %.5f)' % (human_string, score))